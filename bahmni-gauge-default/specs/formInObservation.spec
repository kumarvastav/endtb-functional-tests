...
* Create a "xueying57" form using "obs"
* Login to app and navigate to "Clinical" app
* Select existing patient from patient listing page under tab "Active"
* Navigate to consultation
* Add the "xueying57" exited form
* Enter "123" into control
* Save the consultation

* Navigate to dashboard
* Go to form builder page
* Enter version "1" of "xueying57" form details
* Click on Edit
* Confirm edit
* Save "xueying57" form using "obs_obsGroup" by API
* Navigate to form list
* Enter version "2" of "xueying57" form details
* Click on publish
* Navigate to dashboard
