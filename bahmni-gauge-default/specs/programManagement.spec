...
//Program Management Workflows - Verify Patient Summary Data based on Program Filter
//-----------------------------------------
//T ags: regression, sanity
//* On the login page
//* Login to the application
//* Click on registration app
//* Click on create new patient link
...
//* Enroll patient to the program
//    |name|dateOfRegistration|patientStatus|treatmentDate|programStatus|
//    |HIV Program|21/10/2016|Stage 1|23/10/2016|Clinical Stage 1|
//* Navigate to consultation
//*

//* Create n following patient using api
//    |prefix|firstName|lastName|gender|dateOfBirth|district|
//    |GAN|James Jr|Johns|M|20/01/2000|Pune|
//* Enroll patient to the program
//    |name|dateOfRegistration|patientStatus|treatmentDate|programStatus|
//    |HIV Program|21/10/2016|Stage 1|23/10/2016|Clinical Stage 1|
//* Open Visit for Patient
//* Go to "Treatment" tab
//* Create drug order
...
//    |01-11-2016|Blood|12345|Sample collected Note 1|Negative|4321|Yes|02-11-2016|12:12|03-11-2016|34567|ACD - Active Case Detection|
//* Verify patient details
//* Register the patient to following program
//    |name|dateOfRegistration|
//    |TB Program|30/10/2016|
//* Open visit for previous patient using api
//    |location|type|
